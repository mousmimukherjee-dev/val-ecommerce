...
export const metadata: Metadata = {
  title: "VAL",
  description: "A minimal fashion e-commerce site featuring category-based product browsing, a shopping cart with quantity management, and a clean, modern design",
};
